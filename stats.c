...
// [branch 012] Wrap perror into a single-parameter call
static void spf_perror1(void *param)
{
    delayed_perror((int)(uintptr_t)param, "Can't allocate space for stats structure: calloc");
}
static void spf_perror2(void *param)
{
    delayed_perror((int)(uintptr_t)param, "Can't allocate space for copy of prefix: malloc");
}
...
// [branch 012] Wrap perror into a single-parameter call
static void spd_perror1(void *param)
{
    delayed_perror((int)(uintptr_t)param, "Can't allocate stats response: malloc");
}

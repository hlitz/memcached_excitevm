...
#include "/afs/ir/users/h/l/hlitz//sitevm_dune/excitevm/excitevm_c.h"
...
__attribute__((transaction_pure)) int __printf_chk(int, const char*, ...);
//__attribute__((transaction_pute)) int __snprintf_chk(char*, size_t, int, size_t, const char*, ...);
...
// [branch 004b] This function is called from a relaxed transaction
// [branch 012b] With fprintf oncommit, this becomes safe
__attribute__((transaction_safe)) //assaf change back
